...
const VIP_WALLETS: Record<string, { name: string; note: string }> = {
  ...
  '0xd7a678fcf72c1b602850ef2f3e2d668ec41fa0ed': {
    name: 'Winner d7a678',
    note: 'BTC short @$125K exact top (Oct 6), cashed out +$4.6M Jan 31, account empty — watching for return',
  },
};
...
const WHALES: Record<string, WhaleEntry> = {
  ...
  '0x3c363e96d22c056d748f199fb728fc80d70e461a': { name: 'BTC/LIT Trader', tier: 'CONVICTION', weight: 0.80 },
  ...
  '0x92e9773ad2b4ba6e2e57e7fc1f9305aef80ab6c2': { name: 'ETH Whale', tier: 'CONVICTION', weight: 0.80 },
  ...
  '0x8a0cd16a004e21e04936a0a01c6f5a49ff937914': { name: 'ZEC Conviction', tier: 'CONVICTION', weight: 0.75 },
